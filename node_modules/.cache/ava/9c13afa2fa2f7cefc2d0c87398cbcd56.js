...
var _asyncToGenerator2 = require('/home/n4ml3ss-2/cursos/jsdefinitivo/platzigram-client/node_modules/babel-runtime/helpers/asyncToGenerator.js');
...
test('client', t => {
  ...
  t.is(_rec4._expr(_rec4._capt(typeof _rec4._capt(_rec4._capt(client, 'arguments/0/argument/object').listPictures, 'arguments/0/argument'), 'arguments/0'), {
    content: 't.is(typeof client.listPictures, \'function\')',
    filepath: 'test/client-test.js',
    line: 26,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"UnaryExpression","operator":"typeof","argument":{"type":"MemberExpression","object":{"type":"Identifier","name":"client","range":[12,18]},"property":{"type":"Identifier","name":"listPictures","range":[19,31]},"computed":false,"range":[12,31]},"prefix":true,"range":[5,31]},{"type":"StringLiteral","value":"function","range":[33,43]}],"range":[0,44]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"typeof"},"value":"typeof","range":[5,11]},{"type":{"label":"name"},"value":"client","range":[12,18]},{"type":{"label":"."},"range":[18,19]},{"type":{"label":"name"},"value":"listPictures","range":[19,31]},{"type":{"label":","},"range":[31,32]},{"type":{"label":"string"},"value":"function","range":[33,43]},{"type":{"label":")"},"range":[43,44]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'function');
  t.is(_rec5._expr(_rec5._capt(typeof _rec5._capt(_rec5._capt(client, 'arguments/0/argument/object').listPicturesByTag, 'arguments/0/argument'), 'arguments/0'), {
    content: 't.is(typeof client.listPicturesByTag, \'function\')',
    filepath: 'test/client-test.js',
    line: 27,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"UnaryExpression","operator":"typeof","argument":{"type":"MemberExpression","object":{"type":"Identifier","name":"client","range":[12,18]},"property":{"type":"Identifier","name":"listPicturesByTag","range":[19,36]},"computed":false,"range":[12,36]},"prefix":true,"range":[5,36]},{"type":"StringLiteral","value":"function","range":[38,48]}],"range":[0,49]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"typeof"},"value":"typeof","range":[5,11]},{"type":{"label":"name"},"value":"client","range":[12,18]},{"type":{"label":"."},"range":[18,19]},{"type":{"label":"name"},"value":"listPicturesByTag","range":[19,36]},{"type":{"label":","},"range":[36,37]},{"type":{"label":"string"},"value":"function","range":[38,48]},{"type":{"label":")"},"range":[48,49]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'function');
...
test('getPicture', (() => {
  var _ref = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    t.deepEqual(_rec9._expr(_rec9._capt(image, 'arguments/0'), {
      content: 't.deepEqual(image, result)',
      filepath: 'test/client-test.js',
      line: 44,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"image","range":[12,17]},{"type":"Identifier","name":"result","range":[19,25]}],"range":[0,26]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"image","range":[12,17]},{"type":{"label":","},"range":[17,18]},{"type":{"label":"name"},"value":"result","range":[19,25]},{"type":{"label":")"},"range":[25,26]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), _rec10._expr(_rec10._capt(result, 'arguments/1'), {
      content: 't.deepEqual(image, result)',
      filepath: 'test/client-test.js',
      line: 44,
      async: true,
...
test('savePicture', (() => {
  var _ref2 = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    }).post(`/`, newImage).reply(201, image);

    let result = yield client.savePicture(newImage, token);

    t.deepEqual(_rec11._expr(_rec11._capt(result, 'arguments/0'), {
      content: 't.deepEqual(result, image)',
      filepath: 'test/client-test.js',
      line: 67,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"result","range":[12,18]},{"type":"Identifier","name":"image","range":[20,25]}],"range":[0,26]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"result","range":[12,18]},{"type":{"label":","},"range":[18,19]},{"type":{"label":"name"},"value":"image","range":[20,25]},{"type":{"label":")"},"range":[25,26]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), _rec12._expr(_rec12._capt(image, 'arguments/1'), {
      content: 't.deepEqual(result, image)',
      filepath: 'test/client-test.js',
      line: 67,
      async: true,
...
test('likePicture', (() => {
  var _ref3 = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    nock(options.endpoints.pictures).post(`/${ image.publicId }/like`).reply(200, image);

    let result = yield client.likePicture(image.publicId);

    t.deepEqual(_rec13._expr(_rec13._capt(image, 'arguments/0'), {
      content: 't.deepEqual(image, result)',
      filepath: 'test/client-test.js',
      line: 83,
      async: true,
      ...
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"image","range":[12,17]},{"type":{"label":","},"range":[17,18]},{"type":{"label":"name"},"value":"result","range":[19,25]},{"type":{"label":")"},"range":[25,26]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), _rec14._expr(_rec14._capt(result, 'arguments/1'), {
      content: 't.deepEqual(image, result)',
      filepath: 'test/client-test.js',
      line: 83,
      async: true,
...
test('listPictures', (() => {
  var _ref4 = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    nock(options.endpoints.pictures).get('/list').reply(200, images);

    let result = yield client.listPictures();

    t.deepEqual(_rec15._expr(_rec15._capt(images, 'arguments/0'), {
      content: 't.deepEqual(images, result)',
      filepath: 'test/client-test.js',
      line: 97,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"images","range":[12,18]},{"type":"Identifier","name":"result","range":[20,26]}],"range":[0,27]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"images","range":[12,18]},{"type":{"label":","},"range":[18,19]},{"type":{"label":"name"},"value":"result","range":[20,26]},{"type":{"label":")"},"range":[26,27]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), _rec16._expr(_rec16._capt(result, 'arguments/1'), {
      content: 't.deepEqual(images, result)',
      filepath: 'test/client-test.js',
      line: 97,
      async: true,
...
test('listPicturesByTag', (() => {
  var _ref5 = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    nock(options.endpoints.pictures).get(`/tag/${ tag }`).reply(200, images);

    let result = yield client.listPicturesByTag(tag);

    t.deepEqual(_rec17._expr(_rec17._capt(images, 'arguments/0'), {
      content: 't.deepEqual(images, result)',
      filepath: 'test/client-test.js',
      line: 112,
      async: true,
      ...
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"images","range":[12,18]},{"type":{"label":","},"range":[18,19]},{"type":{"label":"name"},"value":"result","range":[20,26]},{"type":{"label":")"},"range":[26,27]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), _rec18._expr(_rec18._capt(result, 'arguments/1'), {
      content: 't.deepEqual(images, result)',
      filepath: 'test/client-test.js',
      line: 112,
      async: true,
...
test('saveUser', (() => {
  var _ref6 = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    nock(options.endpoints.users).post('/', newUser).reply(201, user);

    let result = yield client.saveUser(newUser);

    t.deepEqual(_rec19._expr(_rec19._capt(result, 'arguments/0'), {
      content: 't.deepEqual(result, user)',
      filepath: 'test/client-test.js',
      line: 132,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"result","range":[12,18]},{"type":"Identifier","name":"user","range":[20,24]}],"range":[0,25]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"result","range":[12,18]},{"type":{"label":","},"range":[18,19]},{"type":{"label":"name"},"value":"user","range":[20,24]},{"type":{"label":")"},"range":[24,25]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), _rec20._expr(_rec20._capt(user, 'arguments/1'), {
      content: 't.deepEqual(result, user)',
      filepath: 'test/client-test.js',
      line: 132,
      async: true,
...
test('getUser', (() => {
  var _ref7 = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    nock(options.endpoints.users).get(`/${ user.username }`).reply(200, user);

    let result = yield client.getUser(user.username);

    t.deepEqual(_rec21._expr(_rec21._capt(result, 'arguments/0'), {
      content: 't.deepEqual(result, user)',
      filepath: 'test/client-test.js',
      line: 146,
      async: true,
      ...
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"result","range":[12,18]},{"type":{"label":","},"range":[18,19]},{"type":{"label":"name"},"value":"user","range":[20,24]},{"type":{"label":")"},"range":[24,25]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), _rec22._expr(_rec22._capt(user, 'arguments/1'), {
      content: 't.deepEqual(result, user)',
      filepath: 'test/client-test.js',
      line: 146,
      async: true,
...
test('auth', (() => {
  var _ref8 = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    nock(options.endpoints.auth).post('/', credentials).reply(200, token);

    let result = yield client.auth(credentials.username, credentials.password);

    t.deepEqual(_rec23._expr(_rec23._capt(result, 'arguments/0'), {
      content: 't.deepEqual(result, credentials)',
      filepath: 'test/client-test.js',
      line: 165,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"result","range":[12,18]},{"type":"Identifier","name":"credentials","range":[20,31]}],"range":[0,32]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"result","range":[12,18]},{"type":{"label":","},"range":[18,19]},{"type":{"label":"name"},"value":"credentials","range":[20,31]},{"type":{"label":")"},"range":[31,32]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), _rec24._expr(_rec24._capt(credentials, 'arguments/1'), {
      content: 't.deepEqual(result, credentials)',
      filepath: 'test/client-test.js',
      line: 165,
      async: true,
...
//# sourceMappingURL=../node_modules/.cache/ava/9c13afa2fa2f7cefc2d0c87398cbcd56.js.map