...
test('auth', (() => {
  var _ref8 = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    t.deepEqual(_rec23._expr(_rec23._capt(result, 'arguments/0'), {
      content: 't.deepEqual(result, token)',
      filepath: 'test/client-test.js',
      line: 165,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"result","range":[12,18]},{"type":"Identifier","name":"token","range":[20,25]}],"range":[0,26]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"result","range":[12,18]},{"type":{"label":","},"range":[18,19]},{"type":{"label":"name"},"value":"token","range":[20,25]},{"type":{"label":")"},"range":[25,26]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), _rec24._expr(_rec24._capt(token, 'arguments/1'), {
      content: 't.deepEqual(result, token)',
      filepath: 'test/client-test.js',
      line: 165,
      async: true,
...
//# sourceMappingURL=../node_modules/.cache/ava/f42d8ae39d756e40290885f40045deb7.js.map